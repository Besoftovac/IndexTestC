...
namespace Travel
{
        ...
        [ServiceContract]
        //[ServiceContractAttribute(Namespace= "http://localhost:51855/WCFMedmar.svc")]
        public interface ITravelService
        {
            ...
            /// </summary>
            [OperationContract]
            [WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Xml, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "synchronize/1")]
            WebServiceProviderResponse synchronize(WebServiceConsumerRequest webServiceConsumerRequest);
        }


    [AspNetCompatibilityRequirements(RequirementsMode = AspNetCompatibilityRequirementsMode.Allowed)]
    public class sincService : ITravelService
        {
            WebServiceProviderResponse ITravelService.synchronize(WebServiceConsumerRequest webServiceConsumerRequest)
            {
    ...
    [DataContract]
        ...
        /// </summary>
        [DataContract]
        public class WebServiceProviderResponse : ITravelService
        {
            /// <summary>
            /// The unique id of current talking 
            /// This Id is generated by HC
